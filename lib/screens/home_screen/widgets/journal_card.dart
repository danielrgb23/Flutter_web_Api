...
import 'package:flutter_webapi_first_course/helpers/loggout.dart';
import 'package:flutter_webapi_first_course/helpers/monthyear.dart';
    ...
    if (journal != null) {
      ...
      return InkWell(
        ...
        child: Container(
          ...
          alignment: Alignment.center,
          child: Text(
            "${WeekDay(showedDate).short} - ${showedDate.day} de ${MonthYear(showedDate).long} - ${showedDate.year}",
    ...
    Navigator.pushNamed(
      ...
      if (value != null && value == true) {
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(const SnackBar(content: Text('Falha ao registrar!')));
      }
    });
  }
  ...
  removeJournal(BuildContext context) {
    ...
    if (journal != null) {
      showConfirmationDialog(
        context,
        content: "Deseja remover essa anotação?",
